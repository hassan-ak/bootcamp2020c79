...
export async function handler(event: any, context: any) {
  // If you're using AWS Lambda with callbacks, be sure to set context.callbackWaitsForEmptyEventLoop = false;
  // in your main handler. This will allow the freezing of connections and will prevent Lambda
  // from hanging on open connections.
  // See here for more information. If you are using async functions, this is no longer necessary.
